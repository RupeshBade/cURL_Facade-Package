...
return [
    'connections' => [
        ...
        'jsonplaceholder' => [
            ...
            // Stays clean—no keys sent here!
        ],
        'mock_api_2' => [
            'base_url'   => env('MOCK_API_2_URL', 'https://6a2912e8f59cb8f65f1c674f.mockapi.io/api/v1'),
            'app_key'    => env('MOCK_API_APP_KEY'),     // Reusing the same secure env key
            'key_secret' => env('MOCK_API_KEY_SECRET'), // Reusing the same secure env secret
        ],
    ],
];
